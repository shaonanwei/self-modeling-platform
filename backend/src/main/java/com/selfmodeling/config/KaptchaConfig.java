...
public class KaptchaConfig {
    ...
    public DefaultKaptcha defaultKaptcha() {
        ...
        properties.setProperty("kaptcha.textproducer.font.color", "55,95,150");
        properties.setProperty("kaptcha.background.clear.from", "240,245,255");
        properties.setProperty("kaptcha.background.clear.to", "220,230,245");
        ...
        properties.setProperty("kaptcha.noise.color", "140,170,210");
